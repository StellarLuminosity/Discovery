...
class MyParser(BaseParser):
    ...
    __OUTPUT_DESCRIPTION = f'{PROMPTS_ROOT}/BugHunterFromSarif/BugHunterFromSarif.output.txt'
    ...
    def get_format_instructions(self) -> str:
        ...
        patch_report_template = open(f'{PROMPTS_ROOT}/BugHunterFromSarif/extras-lang/warning_reports/report.{current_language}', 'r').read()
...
class BugHunterFromSarif(AgentWithHistory[dict,str]):
    ...
    __SYSTEM_PROMPT_TEMPLATE__ = f'{PROMPTS_ROOT}/BugHunterFromSarif/system.j2'
    __USER_PROMPT_TEMPLATE__ = f'{PROMPTS_ROOT}/BugHunterFromSarif/user.j2'
